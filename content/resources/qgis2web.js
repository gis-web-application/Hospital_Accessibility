...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [85962.027702, 2891856.896309, 523739.396232, 3173876.987617], maxZoom: 28, minZoom: 6, projection: new ol.proj.Projection({
            code: 'EPSG:5266',
...
map.getView().fit([85962.027702, 2891856.896309, 523739.396232, 3173876.987617], map.getSize());
